...
class TestExercicio < Minitest::Test
  # Rules
  # 1. You cannot change the value of the expectations (first value of assert_equal)
  # 2. You cannot change the values of the defined variables

  def test_exercice01
    i1, i2 = 1, 2

    assert_equal 4, i2 + i2
    assert_equal 0.5, i2 - i1 - 0.5
    assert_equal -2, i2 * i1 * -1
    assert_equal 5, i2 * i2 + i1
    assert_equal 0.5, i1 / i2.to_f
  end

  def test_exercice02
    assert_equal 0, (10 - 1) % 3
  end
