...
class TestExercicio < Minitest::Test
  ...
  def test_exercicio05 #ok
    skip
    i = 0

    assert_equal 2, i += 1 + 1
    assert_equal -2, (i -= 1) - 3 
    assert_equal 1, i ||= 2 + 3
    assert_equal 2, (i ||= 2) + 1 
  end
end
