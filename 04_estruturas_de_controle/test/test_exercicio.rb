...
class TestExercicio < Minitest::Test
  ...
  def mes_invalido
    assert_equal 'test_mes_invalido', nome_do_mes(0)
    assert_equal 'test_mes_invalido', nome_do_mes(13)
    assert_equal 'test_mes_invalido', nome_do_mes('nil')
    assert_equal 'test_mes_invalido', nome_do_mes('1')
  end
