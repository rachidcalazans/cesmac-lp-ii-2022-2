...
require "./prova_03/app/tempo"

class TestTempo < Minitest::Test

    def test_Tempo
        
        tempo = Tempo.new("./prova_03/proposals.txt")
        ...
        assert_equal tempo.list_palestra , result_lines_tempo
    end
    ...
    def test_tempo_das_falas
        ...
        assert_equal tempo.list_tempo_das_falas, duracao
    end
    ...
    def test_tempo
        ...
        assert_equal hora, tempo.list_tempo
