...
require "./prova_03/app/Organizacao"

class TestOrganizacao < Minitest::Test
    def test_Organizacao
        organizacao = Organizacao.new("./prova_03/proposals.txt")

        result_lines_organizacao = [
        ...
        assert_equal organizacao.list_palestra , result_lines_organizacao
    end
    ...
    def test_tempo_das_falas
        ...
        assert_equal organizacao.list_tempo_das_falas, duracao
    end
    ...
    def test_tempo
        ...
        assert_equal hora, organizacao.list_tempo
