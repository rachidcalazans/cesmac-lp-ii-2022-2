...
require "./prova_03/app/cronograma"

class Test_Cronograma < Minitest::Test
    def test_Cronograma

        cronograma = Cronograma.new("./prova_03/proposals.txt")
    ...
    def test_time
        planejamento = Cronograma.new("./prova_03/proposals.txt")
        hora = ["9:00"]
