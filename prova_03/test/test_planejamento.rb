...
require "./prova_03/app/planejamento"

class TestPlanejamento < Minitest::Test
    def test_planejamento
        ...
        assert_equal planejamento.list_palestra , result_lines_planejamento
    end
    ...
    def test_tempo_das_falas
        ...
        assert_equal planejamento.list_tempo_das_falas, duracao
    end
    ...
    def test_tempo
        ...
        assert_equal hora, planejamento.list_tempo
