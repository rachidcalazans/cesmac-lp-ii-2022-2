...
require "./prova_03/app/Programacao"

class TestProgramacao < Minitest::Test

    def test_programacao

        programacao = Programacao.new("./prova_03/proposals.txt")

        result_lines_programacao = [
        ...
        assert_equal programacao.list_palestra , result_lines_programacao
    end

    def test_tempo_das_falas
        programacao = Programacao.new("./prova_03/proposals.txt")
        duracao = [6, 45, 30, 45, 45, 5, 60, 45, 30, 30, 45, 60, 60, 45, 30, 30, 60, 30, 30]

        assert_equal programacao.list_tempo_das_falas(), duracao
    end
    ...
    def test_tempo
        ...
        assert_equal hora, programacao.list_tempo
