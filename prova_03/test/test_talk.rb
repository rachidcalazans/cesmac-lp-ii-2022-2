...
require './prova_03/app/talk'


class TestTalks < Minitest::Test

    def test_talks

        talk = Talk.new ("./prova_03/proposals.txt")

        expected_listas_talk = [
        ...
        assert_equal expected_listas_talk, talk.show_talk
    ...
    def test_talk_time
        ...
        assert_equal talk.show_time_talks
, expected_min
    ...
    def test_hours
        ...
        assert_equal expected_hours, talk.show_time
