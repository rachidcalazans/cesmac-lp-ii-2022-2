...
require "./prova_03/app/prova"

class test_Schedule < Minitest::Test
    def test_Schedule

        schedule = Schedule.new("./prova_03/proposals.txt")
        ...
        assert_equal schedule.ls_lecture , result_lines_planejamento
    end

    def test_time
        planejamento = Schedule.new("./prova_03/proposals.txt")
        hora = ["9:00"]
