...
class TestConference < Minitest::Test
    ...
    def test_programacao
        ...
        assert_equal conference.list_palestra , result_lines_conference
    end

    def test_tempo_das_falas
        programacao = Conference.new("./prova_03/proposals.txt")
        duracao = [6, 45, 30, 45, 45, 5, 60, 45, 30, 30, 45, 60, 60, 45, 30, 30, 60, 30, 30]

        assert_equal conference.list_tempo_das_falas(), duracao
    end
    ...
    def test_tempo
        ...
        assert_equal hora, conference.list_tempo
