...
class TestConferencia < Minitest::Test
    ...
    def test_conferencia_palestra
        ...
        conferencia = Conf.new("./prova_03/proposals.txt")

        expected_list_palestra = [
        ...
        assert_equal expected_list_palestra, conferencia.list_palestra
    end

    def test_conferencia_tempo

        conferencia = Conferencia.new('./prova_03/proposals.txt')

        expected_minu = [60, 45, 30, 45, 45, 5, 60, 45, 30, 30, 45, 60, 60, 45, 30, 30, 60, 30, 30]

        assert_equal conferencia.list_temp_palestra, expected_minu
    end
    ...
    def test_horas
        ...
        assert_equal expected_horas, conf.list_horas
