...
require "./prova_03/conferencia"

class Test_Conferencia < Minitest::Test
    def test_Conferencia

        conference = Conferencia.new("./prova_03/proposals.txt")
    ...
    def test_conv_tempo
        planejamento = Conferencia.new("./prova_03/proposals.txt")
